  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-4 gap-3">
        <KPICard title="Total EWBs"    value="7" sub="July 2025" icon={Truck}         accent="#1A1A1A" />
            ...
            <tbody>
              {ewayBills.map((e, i) => (
                <tr key={e.id} className="border-b border-[#F5F4EF] hover:bg-[#F5F4EF] cursor-pointer" onClick={() => setDrawer(e)}>
                  <td className="px-4 py-3 font-mono text-xs text-[#1A1A1A] font-semibold">{e.ewbNo}</td>
                  ...
                  <td className="px-4 py-3" onClick={ev => ev.stopPropagation()}>
                    <div className="flex gap-1">
                      {e.status === 'Active' && <button className="px-2 py-1 text-xs bg-[#ECEEEF] text-[#1A1A1A] rounded-md hover:bg-[#D4D3CE]">Extend</button>}
