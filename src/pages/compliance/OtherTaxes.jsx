...
const tdsCols = [
  ...
  {key:'section',label:'Section',render:v=><span className="font-mono text-xs bg-[#F5F4EF] px-1.5 py-0.5 rounded">{v}</span>},
          ...
          {taxTab==='TDS'?(
            <>
              <div className="flex justify-between items-center">
                ...
                <button className="px-3 py-1.5 border border-[#D4D3CE] text-[#787774] text-xs rounded-lg hover:bg-[#F5F4EF]">Export CSV</button>
              </div>
