      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="col-span-2 bg-white border border-[#D4D3CE] rounded-xl p-5">
          ...
          {loading ? (
            ...
            <div className="h-40 flex items-center justify-center text-xs text-[#AEACA8]">{isPaired ? 'No expense data for this period' : 'Pair desktop app to see expenses'}</div>
          ) : (
        ...
        <div className="bg-white border border-[#D4D3CE] rounded-xl p-5">
          ...
          {loading ? (
            ...
            <div className="h-40 flex items-center justify-center text-xs text-[#AEACA8]">No data</div>
          ) : (
            <>
