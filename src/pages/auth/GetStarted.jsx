        ...
        <div className="w-full max-w-md">
          ...
          {step === 1 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div>
                <label className="text-[11px] font-semibold text-[#AEACA8] uppercase tracking-widest block mb-1.5">Full Name</label>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div>
                <label className="text-[11px] font-semibold text-[#AEACA8] uppercase tracking-widest block mb-1.5">Email Address <span className="text-[#AEACA8] font-normal normal-case">(optional)</span></label>
                <div className="relative">
                  <Mail size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#AEACA8]" />
                  <input
                    autoFocus
                    type="email"
                    value={email}
                ...
                <p className="text-xs text-[#AEACA8] mt-2">Your email will be visible in your profile and desktop app. You can update it anytime in Settings.</p>
              </div>
            </div>
          )}
          ...
          {step === 5 && (
            <div className="space-y-6">
              ...
              <div className="bg-[#F5F4EF] rounded-xl p-4 space-y-3 border border-[#E9E8E3]">
                <p className="text-xs font-semibold text-[#AEACA8] uppercase tracking-widest">Your Setup</p>
                {[
          ...
          <div className="flex gap-3 mt-8">
            {step > 1 && (
              <button
                onClick={back}
                className="flex items-center gap-2 px-5 h-11 rounded-xl text-sm font-medium border border-[#D4D3CE] text-[#787774] hover:bg-[#F5F4EF] tracking-tight transition-colors"
              >
          ...
          {step === 1 && user?.name && (
            <p className="text-center mt-4">
              <button onClick={() => navigate('/')} className="text-xs text-[#AEACA8] hover:text-[#787774] transition-colors">
                Skip setup →
              </button>
            </p>
          )}
