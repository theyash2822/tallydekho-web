    ...
    <div className="min-h-screen flex bg-[#F5F4EF]">
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-white">
        <div className="w-full max-w-sm">
          ...
          {/* OTP input */}
          <div className="mb-6">
            <label className="text-[11px] font-semibold text-[#AEACA8] uppercase tracking-widest block mb-2">
              4-Digit OTP
            </label>
            <input
              ref={inputRef}
              ...
              onPaste={handlePaste}
              placeholder="· · · ·"
              className={`w-full h-16 text-center text-4xl font-bold bg-white border-2 rounded-2xl outline-none transition-all placeholder:text-[#D4D3CE] placeholder:text-3xl ${
                error
