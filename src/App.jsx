    ...
    if (this.state.hasError) {
      return (
        <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'100vh',gap:16,fontFamily:'sans-serif'}}>
          ...
          <div style={{fontSize:16,fontWeight:600,color:'#37352F'}}>Something went wrong</div>
          ...
          <button onClick={()=>{ localStorage.clear(); window.location.href='/auth/login'; }}
            style={{padding:'8px 20px',background:'#37352F',color:'white',border:'none',borderRadius:8,cursor:'pointer',fontSize:14}}>
            Back to Login
          </button>
        </div>
      );
